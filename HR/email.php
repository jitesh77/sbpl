...
$headers = "From: khandelwalsurendra9@gmail.com\r\n";

$headers .= "Reply-To: khandelwalsurendra9@gmail.com\r\n";

$headers .= "Return-Path: khandelwalsurendra9@gmail.com\r\n";
...
if (mail($to,$subject,$txt,$headers, '-freturn@digiwage.org')) {
    echo 1;
